...
function displayMovies(movies) {
  const libraryParse = JSON.parse(localStorage.getItem('library')) || [];

  if (libraryParse.length === 0) {
...
function showEmptyLibraryMessage() {
  const message = document.querySelector('.film-list');
  message.innerHTML =
    '<p>OOOPS..<br>We are very sorry!You don’t have any movies at your library</p>
